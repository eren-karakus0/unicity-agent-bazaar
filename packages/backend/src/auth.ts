...
/** A challenge the user must sign to prove control of a wallet. */
...
export class AuthService {
  ...
  constructor(opts: AuthServiceOptions) {
    ...
    this.domain = opts.domain ?? 'Unicity Agent Bazaar';
...
/** The principal used to key marketplace records + label a party. */
