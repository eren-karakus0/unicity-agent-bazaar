/**
 * Lightweight file persistence for the marketplace state. A single JSON
 * snapshot, written atomically (tmp + rename). This keeps listings, jobs,
 * reviews, reputation, and favorites across process restarts on any host with a
